            ...
            {filteredReports.map((report) => (
              ...
              >
                ...
                >
                  ...
                  <ChevronDown 
                    className={`w-5 h-5 text-gray-400 cursor-pointer hover:text-gray-600 transition-all duration-200 ${
                ...
                {expandedReports.has(report.id) && (
                  ...
                  >
                    <div className="space-y-3">
                      <div>
                        <h4 className="font-medium text-gray-900 dark:text-white mb-2">Vollständiger Bericht:</h4>
                        <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed whitespace-pre-wrap">
                          {report.full_text || 'Kein vollständiger Text verfügbar.'}
                        </p>
                      </div>
                      
                      {report.summary && (
                        <div>
                          <h4 className="font-medium text-gray-900 dark:text-white mb-2">Zusammenfassung:</h4>
                      ...
                      <div className="flex items-center justify-between pt-2 text-xs text-gray-500 dark:text-gray-400">
                        <span>Erstellt am: {new Date(report.date).toLocaleString('de-DE')}</span>
                        <span>Arzt: {report.doctor}</span>
                      </div>
                    </div>
                  </motion.div>
                )}
